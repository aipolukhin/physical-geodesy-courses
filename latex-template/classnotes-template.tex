...
\usepackage[top=25mm,bottom=25mm,left=25mm,right=10mm]{geometry}
...
\newcommand\ClassName{Теория фигур планет и гравиметрия}
\newcommand\ClassSemester{Весна 2018}
...
\bf\large Введение. Сведения из математики и высшей геодезии}
%\author{преп. И.~А.~Ощепков}
\author{}
